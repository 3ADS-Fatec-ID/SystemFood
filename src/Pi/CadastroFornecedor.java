...
public class CadastroFornecedor extends JPanel {
	...
	public CadastroFornecedor() {
		...
		textField.setBounds(190, 28, 112, 20);
		add(textField);
		textField.setColumns(10);
		
		textField_1 = new JTextField();
		textField_1.setBounds(190, 59, 112, 20);
		add(textField_1);
		...
		textField_2.setBounds(190, 87, 112, 20);
		add(textField_2);
		...
		textField_3.setBounds(190, 118, 112, 20);
		add(textField_3);
		...
		comboBox.setBounds(190, 148, 112, 22);
		add(comboBox);
		
		textField_4 = new JTextField();
		textField_4.setColumns(10);
		textField_4.setBounds(190, 181, 112, 20);
		add(textField_4);
		...
		textField_5.setBounds(190, 212, 112, 20);
		add(textField_5);
		...
		textField_6.setBounds(190, 241, 112, 20);
		add(textField_6);
		
		JButton btnNewButton = new JButton("Salvar");
		btnNewButton.setBackground(new Color(0, 128, 0));
		btnNewButton.setBounds(340, 133, 89, 23);
		add(btnNewButton);

...
public class CadastroFornecedor extends JPanel {
	...
	public CadastroFornecedor() {
		...
		lblNewLabel_1.setBounds(52, 28, 43, 14);
		add(lblNewLabel_1);
		
		nomeFornecedor = new JTextField();
		nomeFornecedor.setBounds(97, 28, 202, 20);
		add(nomeFornecedor);
		nomeFornecedor.setColumns(10);
		
		JLabel lblNewLabel_2 = new JLabel("E-mail:");
		lblNewLabel_2.setBounds(50, 59, 46, 14);
		add(lblNewLabel_2);
		
		email = new JTextField();
		email.setBounds(97, 59, 202, 20);
		add(email);
		email.setColumns(10);
		
		JLabel lblNewLabel_3 = new JLabel("CNPJ:");
		lblNewLabel_3.setBounds(54, 87, 36, 14);
		add(lblNewLabel_3);
		
		cnpj = new JTextField();
		cnpj.setBounds(97, 87, 202, 20);
		add(cnpj);
		cnpj.setColumns(10);
		
		JLabel lblNewLabel_4 = new JLabel("Telefone:");
		lblNewLabel_4.setBounds(36, 118, 55, 14);
		add(lblNewLabel_4);
		
		telefone = new JTextField();
		telefone.setBounds(97, 118, 202, 20);
		add(telefone);
		telefone.setColumns(10);
		
		JLabel lblNewLabel_5 = new JLabel("Cidade:");
		lblNewLabel_5.setBounds(46, 149, 42, 14);
		add(lblNewLabel_5);
		...
		cidade.setBounds(97, 148, 202, 22);
		add(cidade);
		
		JLabel lblNewLabel = new JLabel("Bairro:");
		lblNewLabel.setBounds(49, 184, 43, 14);
		add(lblNewLabel);
		
		bairro = new JTextField();
		bairro.setColumns(10);
		bairro.setBounds(97, 181, 202, 20);
		add(bairro);
		
		
		
		JLabel lblRua = new JLabel("Rua:");
		lblRua.setBounds(62, 215, 32, 14);
		add(lblRua);
		
		endereco = new JTextField();
		endereco.setColumns(10);
		endereco.setBounds(97, 212, 202, 20);
		add(endereco);
		
		JLabel lblNewLabel_6 = new JLabel("CEP:");
		lblNewLabel_6.setBounds(61, 244, 33, 14);
		add(lblNewLabel_6);
		
		cep = new JTextField();
		cep.setColumns(10);
		cep.setBounds(97, 241, 202, 20);
		add(cep);
